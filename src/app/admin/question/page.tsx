...
// Mock timestamp implementation to replace Firebase
class Timestamp {
  seconds: number;
  nanoseconds: number;
...
type QuestionTypes = MCQQuestion | EssayQuestion;

// Define subject data structure
interface Subject {
  id: string;
  name: string;
  grade: string;
...
const dummySubjects: Subject[] = [
  { id: "math-g6", name: "Mathematics", grade: "Grade 6", questionCount: 24 },
  { id: "science-g6", name: "Science", grade: "Grade 6", questionCount: 18 },
  { id: "english-g6", name: "English", grade: "Grade 6", questionCount: 15 },
  { id: "math-g7", name: "Mathematics", grade: "Grade 7", questionCount: 32 },
  { id: "science-g7", name: "Science", grade: "Grade 7", questionCount: 21 },
  { id: "english-g7", name: "English", grade: "Grade 7", questionCount: 19 },
  { id: "math-g8", name: "Mathematics", grade: "Grade 8", questionCount: 27 },
  { id: "science-g8", name: "Science", grade: "Grade 8", questionCount: 23 },
  { id: "social-g8", name: "Social Studies", grade: "Grade 8", questionCount: 16 }
];
